defmodule Pyex.Interpreter.Helpers do
  ...
  def py_type({:coroutine, _, _}), do: "coroutine"
  def py_type({:asyncio_task, _}), do: "Task"
  def py_type({:asyncio_task_pending, _}), do: "Task"
  ...
  def py_str({:coroutine, name, _}), do: "<coroutine object #{name}>"
  def py_str({:asyncio_task, _}), do: "<Task done>"
  def py_str({:asyncio_task_pending, _}), do: "<Task pending>"
