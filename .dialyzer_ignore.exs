[
  ...
  # MapSet is an opaque type. Dialyzer emits call_without_opaque and
  # contract_with_opaque warnings wherever MapSet values flow through the
  # interpreter's generic pyvalue() union. All usages are correct at runtime.
  # deep_deref/3 is annotated with @dialyzer {:no_opaque} at the source level.
